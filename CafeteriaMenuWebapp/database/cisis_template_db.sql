...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2014 at 07:01 PM
...
CREATE TABLE IF NOT EXISTS `weekly_menu` (
  ...
  `HASALLERGENS` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `weekly_menu` (`ID`, `DAY`, `ITEMNAME`, `PRICE`, `DESCRIPTION`, `ALLERGENS`, `HASALLERGENS`) VALUES
(0, 'Sunday', 'Test1', '0.00', 'Test description1', '', 0),
(1, 'Monday', 'Test2', '0.00', 'Test description', 'Peanuts', 0),
(2, 'Tuesday', 'Test3', '0.00', 'Test description1', '', 0),
(3, 'Wednesday', 'Test4', '0.00', 'Test description1', 'Eggs', 0),
(4, 'Thursday', 'Test5', '0.00', 'Test description1', '', 0),
(5, 'Friday', 'Test6', '0.00', 'Test description1', 'Corn', 0),
(6, 'Saturday', 'Test7', '0.00', 'Test description1', '', 0);
...
ALTER TABLE `code_value`
 ADD PRIMARY KEY (`code_type_id`,`code_value_sequence`);
...
ALTER TABLE `member_education`
 ADD PRIMARY KEY (`member_id`,`me_sequence`);
...
--
ALTER TABLE `event`
MODIFY `event_num` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
